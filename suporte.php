...
<div class="hero-body">
    <div class="container has-text-centered">
      ...
      <p class="subtitle has-text-white">A casa dos seus sonhos pelo preço de um!!</p>
    </div>
</div>
</section>
...
<div class="field">
  <label class="label">Digite a sua dúvida:</label>
  <div class="control">
...
<div class="field is-grouped">
  <div class="control">
    <button class="button is-link is-inverted" type="submit">Enviar dúvida</button> 
  </div>
  <div class="control">
