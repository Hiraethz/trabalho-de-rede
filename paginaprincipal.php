...
<section class="hero is-primary is-small">
  ...
  <div id="navbarBasicExample" class="navbar-menu">
    ...
    <a class="navbar-item has-text-white" href="paginaprincipal.php">
      ...
      <a class="navbar-item has-text-white" href="casas.php">
        Casas
      </a>
...
<div class="hero-body">
    <div class="container has-text-centered">
      <p class="title has-text-white">Casas Bahia Jr</p>
      <p class="subtitle has-text-white">Casas que combinam com você!!!</p>
    </div>
</div>
</section>
...
<div class="card">
  <div class="card-content">
    <p class="title">
      “Ninguém pode entrar duas no mesmo rio, pois quando nele se entra novamente, não se encontra as mesmas águas, e o próprio ser já se modificou.”
    </p>
    <p class="subtitle">- Heráclito de éfeso</p>
  </div>
...
<section class="section">
  <h1 class="title">Futuras casas a venda</h1>
...
<div class="columns">
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa de frente para a praia em cancun</p>
        <p class="subtitle is-6"><strong>Vendedor: marcio</strong></p>
      </div>
    </div>

    <div class="content">
      </a>Valor: R$300.000.00</a>
      <br/>
    </div>
  </div>
</div>
  ...
  <div class="card-image">
    <figure class="image is-4by3">
      <img
        src="/arquiteto-aquiles-nicolas-kilaris-casa-europa-1.jpg"
        alt="Placeholder image"
      />
    </figure>
  </div>
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa Em Barcelona</p>
        <p class="subtitle is-6"><strong>Vendedor: Romeo</strong></p>
      </div>
    </div>

    <div class="content">
<a>Valor: R$850.000.00</a>
      <br/>
    </div>
  </div>
</div>
  ...
  <div class="card-image">
    <figure class="image is-4by3">
      <img
        src="/5147bca217820f3ec5caac8b.jpg"
        alt="Placeholder image"
      />
    </figure>
  </div>
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa em Bratislava</p>
        <p class="subtitle is-6"><strong>Vendedora: Mira</strong></p>
      </div>
    </div>

    <div class="content">
</a>Valor: R$650.000.00</a>
      <br/>
    </div>
  </div>
</div>
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa em Marselha</p>
        <p class="subtitle is-6"><strong>Vendedor: Matthieu</strong></p>
      </div>
    </div>

    <div class="content">
</a>Valor: R$1.500.000.00</a>
      <br/>
    </div>
  </div>
</div>
