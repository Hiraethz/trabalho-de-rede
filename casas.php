...
<div class="hero-body">
    <div class="container has-text-centered">
      <p class="title has-text-white">Casas de todos os valores</p>
      <p class="subtitle has-text-white">A casa certa para a pessoa certa!</p>
    </div>
</div>
</section>
...
<div class="container">
    <div class="has-text-centered">
        <p class="title">Casa em destaque</p>
    </div>
  ...
  <div class="carousel">
    <div class="media">
      <div class="media-content">
        <figure class="image">
          <img
            src="/casas-bonitas-e-modernas1-600x395.jpg"
          />
        </figure>
      </div>
      <br>
      <div class="has-text-centered">
      <div class="media-content">
        <p class="title is-4">Casa em balneário camboriú</p>
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="title-info">
        <p class="title is-4">Casa em gramado</p>
        <p class="subtitle is-6">R$150.000.00</p>
      </div>
    </div>
...
<div class="column">
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa em são jose dos campos</p>
        <p class="subtitle is-6">R$450.000.00</p>
      </div>
    </div>
...
<div class="column">
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa em São Paulo</p>
        <p class="subtitle is-6">R$900.000.00</p>
      </div>
    </div>
...
<div class="column">
  ...
  <div class="card-content">
    <div class="media">
      ...
      <div class="media-content">
        <p class="title is-4">Casa em Minas gerais</p>
        <p class="subtitle is-6">R$350.000.00</p>
      </div>
    </div>
